...
//         </div>
//       ) : error ? (
//         <div className="text-xl text-red-600 bg-white p-4 rounded-lg shadow">
//           <p>{error}</p>
//           <button
...
const Header: React.FC<HeaderProps> = ({ loading, error }) => {
  // ✅ Memoized calculation for efficiency
...
export default React.memo(Header); // ✅ Prevents unnecessary re-renders
